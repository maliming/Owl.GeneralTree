...
{
    public class MyTreeDbMigrationService : ITransientDependency
    {
        public ILogger<MyTreeDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IMyTreeDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public MyTreeDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IMyTreeDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<MyTreeDbMigrationService>.Instance;
        }
